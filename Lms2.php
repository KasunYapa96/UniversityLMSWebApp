...
<br> <br>
 ...
 <button class="accordion"> Year 1 </button>
        <div class="panel">
            ...
            <li><a href="hashan.php?modulename=Web Based Application Development	">Web Based Application Development</a></li>
            <li><a href="hashan.php?modulename=Quantitative Techniques for Computing">Quantitative Techniques for Computing</a></li>
            <li><a href="hashan.php?modulename=Computer Technology">Computer Technology</a></li>

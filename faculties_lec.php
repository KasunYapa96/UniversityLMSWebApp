...
<body>
  ...
  <a href="javascript:void(0);" class="icon" onclick="myFunction()">&#9776;</a>
      ...
      <a href="Lms2_lec.php"> <button class="button1"><span>School Of Computing </span></button> </a>
      <br> <br>
	  <a href="sob_lec.php"> <button class="button1"><span>School Of Business </span></button> </a>
      <br> <br>
      <a href="soe_lec.html"> <button class="button1"><span>School Of Engineering </span></button> </a>
